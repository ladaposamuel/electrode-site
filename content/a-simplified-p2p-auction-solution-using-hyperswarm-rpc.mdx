...
draft: false
tags: tutorial, p2p, hyperswarm, nodejs
---
...
The auction server's role would be to listen for incoming connections and handle requests related to auctions and bids, store the auctions in the Hyperbee, 
and distribute the winning bid to the highest bidder.
