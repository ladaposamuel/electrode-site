        ...
        <>
            <section>
                ...
                <div className="flex items-start md:items-center my-8 flex-col md:flex-row">
                    ...
                    <div className="mt-8 md:mt-0 ml-0 md:ml-6 space-y-2 text-neutral-500 dark:text-neutral-400">
                        ...
                        <Link href="https://venhoot.com" className="venhoot-text flex items-center">
              
                    <span>
                    {"👷🏾 "} Currently building <span className="underline">Venhoot</span>, a platform for users to review and share their experiences with online business.
                    </span>
                        </Link>
                        {/* <Link href="/blog" className="flex items-center">
            {"🏢 "}
            ...
            <section className="mt-10">
                ...
                {allBlogs
                    ...
                    .sort((a, b) => new Date(b.publishedAt).getTime() - new Date(a.publishedAt).getTime()) // Step 2
                    .slice(0, 3)
                    .map((post) => (
                        <Link
                            key={post.slug}
